...
MAIN PROC
    ...
    EXIT:
        ...
        ; Convert BX to binary and display it
        MOV CX, 16             ; Set loop counter for 16 bits (since BX is 16-bit)
        MOV BL, 0             ; Clear BL to hold a binary digit
    ...
    SKIP:
        MOV DL, AL            ; Move binary digit to DL
        INT 21H               ; Print the binary digit
        LOOP BIN_LOOP         ; Repeat for all 16 bits
